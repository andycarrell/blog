...
export default function Post1() {
  return (
    <Stack>
      <Stack marginY={[5, 5, 6, 8]} textAlign="center">
        <Heading1>Mocking GraphQL in Cypress</Heading1>
        <Overline>Using graphql-tools v5</Overline>
      </Stack>
      <Callout marginBottom={[4, 4, 5, 5]}>
        ...
        <InternalLink
          href="/posts/[pid]"
          as="/posts/mocking-graphql-in-cypress"
        >
          follow the v6 guide
        </InternalLink>
        . You can find out more about migrating from v5 to v6 in the{" "}
        <ExternalLink href="https://www.graphql-tools.com/docs/migration-from-tools-v5/">
